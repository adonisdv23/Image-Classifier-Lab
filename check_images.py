...
placeholder_dir = r'/Users/adonisvasquez/PycharmProjects/Image-Classifier-Lab'
...
def get_input_args(get_input_dir, get_input_model, get_input_pet_name_file):
    ...
    gia_parser.add_argument('--dir', type=str, default='/Users/adonisvasquez/PycharmProjects/Image-Classifier-Lab',
                            help='Path to folder')
...
def get_pet_labels(get_pet_labels_dir, get_pet_labels_pet_file):
    ...
    gpl_parser.add_argument('--dir', type=str, default='/Users/adonisvasquez/PycharmProjects/Image-Classifier-Lab',
                            help='Path to folder')
...
def classifying_images(classifying_images_dir, pet_dic_to_compare):
    ...
    ci_parser.add_argument('--dir', type=str, default='/Users/adonisvasquez/PycharmProjects/Image-Classifier-Lab',
                           help='Path to folder')
